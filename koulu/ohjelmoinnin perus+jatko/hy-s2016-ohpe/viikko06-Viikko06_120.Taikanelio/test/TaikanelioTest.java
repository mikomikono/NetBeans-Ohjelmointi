...
public class TaikanelioTest {
    ...
    public void lavistajienSummatOikein() {
        ...
        assertEquals("Kun taikaneliö on:\n" + tn + "\nTulee lavistajienSummat-metodin palauttamalla listalla olla arvot 5 ja 5. Nyt ei ollut.", new Integer(5), lavistajienSummat.get(0));
        assertEquals("Kun taikaneliö on:\n" + tn + "\nTulee lavistajienSummat-metodin palauttamalla listalla olla arvot 5 ja 5. Nyt ei ollut.", new Integer(5), lavistajienSummat.get(1));
    }
